    ...
    <div class="container">
        <div class="footer-grid">
            <div class="footer-column">
                ...
                <p style="color: var(--text-muted); font-size: 0.95rem;">Intelligent Crypto Wealth: Aggregating the best
                    DeFi yield with AI-powered security and auto-compounding for maximum returns.</p>
        ...
        <div class="footer-bottom">
            <p>&copy; 2025 Vcoins Decentralized Platform. All rights reserved. | Built for the future of finance.</p>
        </div>
    </div>
</footer>
